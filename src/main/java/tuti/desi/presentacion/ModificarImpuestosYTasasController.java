...
public class ModificarImpuestosYTasasController {
	...
	public String submit(@ModelAttribute("formBean") @Valid ModificarImpuestosYTasasForm formBean, BindingResult result,
		...
		if (action.equals("Modificar")) {
			try {
				...
				impuestosYTasas
						.setTasaAeroportuariaInternacional(formBean.getTasaAeroportuariaInternacionalSeleccionado());
